...
\usepackage[
    pdftitle={Pratik Fandade Resume},
    pdfauthor={Pratik Fandade},
    pdfcreator={Pratik Fandade},
    colorlinks=true,
...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Pratik Fandade

        \vspace{5 pt}

        \normalsize
        \mbox{\hrefWithoutArrow{tel:+1-716-339-8155}{(716) 339-8155}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:pfandade@buffalo.edu}{pfandade@buffalo.edu}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/pratikfandade/}{linkedin}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/prkbuilds}{github}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://leetcode.com/u/Raijin_codes/}{leetcode}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{Buffalo, NY}%
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{University at Buffalo, State University of New York}\end{twocolentry}
